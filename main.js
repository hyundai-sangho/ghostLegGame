const 버튼1 = document.querySelector('#btn1');
const 버튼2 = document.querySelector('#btn2');
const 버튼3 = document.querySelector('#btn3');
const 버튼4 = document.querySelector('#btn4');
const 버튼5 = document.querySelector('#btn5');

const 사다리 = ladder('canvas');

버튼1.addEventListener('click', () => 사다리.find(0, 'red'));
버튼2.addEventListener('click', () => 사다리.find(1, 'blue'));
버튼3.addEventListener('click', () => 사다리.find(2, 'green'));
버튼4.addEventListener('click', () => 사다리.find(3, 'purple'));
버튼5.addEventListener('click', () => 사다리.find(4, 'orange'));
